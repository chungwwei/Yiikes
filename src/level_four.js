...
export class Level4 extends Phaser.Scene {
    ...
    constructor() {
        ...
        this.player = null
        this.spacebar = null
        this.starThreshold = {oneStar: 10, twoStar: 3, threeStar: 1}
        this.shotsFire = 0
    }
    ...
    create() {
        ...
        this.ball1 = this.add.follower(circlePath, circleOrigin[0].x, circleOrigin[0].y, 'blue_circle');
            ...
            if(!this.levelCompleted){
                if(this.coinGroup.numberOfCoinsCollected != 3){
                    ...
                    if(gameState.starSystem.getLevel(4) < 2){
                        gameState.starSystem.setStars(4, 2)
                    }
                } else {
                    if(gameState.starSystem.getLevel(4) < 1){
                        gameState.starSystem.setStars(4, 1)
                ...
                this.choiceLabel = this.add.text(960/2 - 100, 960/2-200, 'Level 4 Completed!', { font: '30px Arial', fill: '#000' });
                if(gameState.starSystem.getLevel(4) == 3){
                    ...
                    this.tipLabel = this.add.text(960/2 - 325, 960/2-300, 'Collect all Coins or Only Use 1 shots to get 3 stars', { font: '30px Arial', fill: '#000' });
