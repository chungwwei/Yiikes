...
export class Level8 extends Phaser.Scene {
    ...
    update(){
        ...
        //Check if player reaches end of levela
        if (Phaser.Geom.Rectangle.Contains(this.endpoint, this.player.x, this.player.y) 
            && (this.numberOfKeys < 1)
                ...
                this.levelCompleted = true
                    ...
                    } else if (gameState.starSystem.getLevel(8) == 2){
                        this.star1 = this.add.sprite(960/2 - 150, 400, 'star')
                        this.star2 = this.add.sprite(960/2, 400, 'star')
                        this.star3 = this.add.sprite(960/2 + 150, 400, 'empty_star')
                        this.tipLabel = this.add.text(960/2 - 325, 960/2-300, 'Collect all Coins and Only Use 2 shots to get 3 stars', { font: '30px Arial', fill: '#000' });
                    } else if (gameState.starSystem.getLevel(8) == 1){
                        this.star1 = this.add.sprite(960/2 - 150, 400, 'star')
